...
# inst = ec2.create_instances(ImageId='ami-0c1a7f89451184c8b', MinCount=1, MaxCount=1, InstanceType='t2.micro',KeyName='CloudComputingProject',
...
cmd1 = "ssh -i CloudComputingProject.pem " + pdn[0]
cmdList = [cmd1 + " mkdir AnjaniCloud",
           cmd1 + " sudo apt-get update",
           cmd1 + " sudo apt-get install g++",
           " scp -i CloudComputingProject.pem MatrixMutliplication.cpp " + pdn[0] + ":~/AnjaniCloud/",
